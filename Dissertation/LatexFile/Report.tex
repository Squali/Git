...
\begin{document}	
	...
	\begin{figure}[H]
		...
		\begin{minipage}{\textwidth}
			\centering
			\includegraphics[width=0.9\textwidth]{GraphCovariate1} % first figure itself
			\caption{Graph Network Example}
			\label{label-image10}
		\end{minipage}\hfill
		\begin{minipage}{\textwidth}
			\centering
			\includegraphics[width=0.9\textwidth]{SimulationCovariates2} % second figure itself
	...
	\begin{figure}[H]
		...
		\begin{minipage}{\textwidth}
			\centering
			\includegraphics[width=0.9\textwidth]{GraphCovariates2} % first figure itself
			\caption{Graph Network Example}
			\label{label-image23}
		\end{minipage}\hfill
		\begin{minipage}{\textwidth}
			\centering
			\includegraphics[width=0.9\textwidth]{PlotCovariates3} % second figure itself
			\caption{Node $1$ and $2$ popularity and sociability}
			\label{label-image24}
		\end{minipage}
	...
	\begin{figure}[H]
		...
		\begin{minipage}{\textwidth}
			\centering
			\includegraphics[width=0.9\textwidth]{GraphSampsonCovariates} % first figure itself
			\caption{Graph Network Example}
			\label{label-image25}
		\end{minipage}\hfill
		\begin{minipage}{\textwidth}
			\centering
			\includegraphics[width=0.9\textwidth]{CovariatesSampsonPLot} % second figure itself
	...
	\begin{figure}[H]
		...
		\begin{minipage}{0.45\textwidth}
			\centering
			\includegraphics[width=0.9\textwidth]{SampsonEM1} % first figure itself
			\caption{sampson clustering t = 1}
			\label{label-image19}
		\end{minipage}\hfill
		\begin{minipage}{0.45\textwidth}
			\centering
			\includegraphics[width=0.9\textwidth]{sampsonEM2} % second figure itself
	...
	\begin{figure}[H]
		...
		\begin{minipage}{0.45\textwidth}
			\centering
			\includegraphics[width=0.9\textwidth]{sampsonEM3} % first figure itself
			\caption{sampson clustering t = 3}
			\label{label-image21}
		\end{minipage}\hfill
		\begin{minipage}{0.45\textwidth}
			\centering
			\includegraphics[width=0.9\textwidth]{posteriorSampson} % second figure itself
